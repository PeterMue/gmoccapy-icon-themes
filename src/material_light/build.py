...
def compose_images():
    ...
    for axis in ["x", "y", "z", "a", "b", "c", "u", "v", "w"]:
        composer.add(f"translate_{axis}.png",
    ...
    composer.add(f"touch_off.png",
                 src_file=touch_icons_svg,
                 context="actions",
                 layers=["touch-off"]
                 )
    for axis in ["x", "y", "z", "a", "b", "c", "u", "v", "w"]:
        composer.add(f"touch_{axis}.png",
                     src_file=touch_icons_svg,
                     context="actions",
    ...
    for state in ["on", "off"]:
        composer.add(f"power_{state}.png",
    ...
    composer.add(f"main_switch_off.png",
                 src_file=main_switch_icons_svg,
                 context="actions",
                 layers=["active", "base"]
                 )
    composer.add(f"main_switch_on.png",
                 src_file=main_switch_icons_svg,
                 context="actions",
                 layers=["idle"]
                 )
    ...
    for active in ["active", "inactive"]:
        for mode in ["manual", "mdi", "auto", "settings", "user_tabs"]:
            composer.add(f"mode_{mode}_{active}.png",
    ...
    for state in ["open", "close"]:
        composer.add(f"fullscreen_{state}.png",
    ...
    composer.add("toolpath.png",
                 src_file=gremlin_control_icons_svg,
                 context="actions",
                 layers=["toolpath"]
                 )
    composer.add("clear.png",
                 src_file=gremlin_control_icons_svg,
                 context="actions",
                 layers=["clear"]
                 )
    composer.add("dimensions.png",
                 src_file=gremlin_control_icons_svg,
                 context="actions",
                 layers=["dimensions"]
                 )
    ...
    for zoom in ["zoom_in", "zoom_out"]:
        composer.add(f"{zoom}.png",
                     src_file=gremlin_control_icons_svg,
                     context="actions",
                     layers=[zoom]
                     )

    composer.add(f"tool_axis_p.png",
                 src_file=gremlin_control_icons_svg,
                 context="actions",
    ...
    for axis in ["x", "y", "z"]:
        composer.add(f"tool_axis_{axis}.png",
                     src_file=gremlin_control_icons_svg,
                     context="actions",
                     layers=["simple_plane", axis]
                     )

    composer.add(f"tool_axis_y_inv.png",
                 src_file=gremlin_control_icons_svg,
                 context="actions",
    ...
    for status in ["active", "inactive"]:
        for coolant in ["mist", "flood"]:
            composer.add(f"coolant_{coolant}_{status}.png",
    ...
    for direction in ["left", "right"]:
        composer.add(f"spindle_{direction}.png",
                     src_file=spindle_icons_svg,
                     context="actions",
                     layers=["spindle", "turn", direction]
                     )
        composer.add(f"spindle_{direction}_on.png",
                     src_file=spindle_icons_svg,
                     context="actions",
    ...
    # spindle stop
    composer.add(f"spindle_stop_on.png",
                 src_file=spindle_icons_svg,
                 context="actions",
                 layers=["spindle", "stop_on"]
                 )
    composer.add(f"spindle_stop.png",
                 src_file=spindle_icons_svg,
                 context="actions",
                 layers=["spindle", "stop"]
                 )
    ...
    for speed in ["slow", "fast"]:
        composer.add(f"jog_speed_{speed}.png",
    ...
    composer.add("window_close.png",
                src_file=notification_icons_svg,
                context="actions",
                layers=["close"]
                )
    composer.add("dialog_information.png",
                src_file=notification_icons_svg,
                context="status",
                layers=["info"]
                )
    composer.add("dialog_warning.png",
                src_file=notification_icons_svg,
                context="status",
                layers=["warn"]
                )
    ...
    composer.add("calculator_open.png",
